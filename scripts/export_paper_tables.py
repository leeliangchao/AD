"""Export paper-ready tables from an aggregated ablation matrix run."""
...
from adrf.statistics.table_export import export_paper_tables


def main() -> int:
    """Export markdown and CSV paper tables for the latest or given matrix directory."""
