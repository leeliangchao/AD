...
def test_reference_diffusion_rejects_unsupported_backend_early() -> None:
    with pytest.raises(ValueError, match="Unsupported diffusion backend"):
        ReferenceDiffusionBasicNormality(backend="diffusers")
